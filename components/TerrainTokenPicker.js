...
function TerrainTokenPicker({ HeaderText = "Draw a token" }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(Container_1.default, { fluid: true, className: "mx-auto min-h-screen", children: [(0, jsx_runtime_1.jsx)(PageTitle_1.default, { HeaderText: HeaderText }), (0, jsx_runtime_1.jsx)(Row_1.default, { id: 'tokensRow', className: 'py-2 mb-4', children: (0, jsx_runtime_1.jsx)(Col_1.default, { className: 'd-flex justify-content-center', children: displayedToken?.img() }) }), (0, jsx_runtime_1.jsxs)(Row_1.default, { id: 'TerrainTokenButtons', className: 'justify-content-center px-1 py-2', children: [(0, jsx_runtime_1.jsx)(Col_1.default, { xs: "auto", className: 'p-1', children: (0, jsx_runtime_1.jsx)(Button_1.default, { variant: "secondary", size: "lg", className: 'px-1', onClick: () => setMountainToken(localTerrainDeck.drawMountainToken()), children: "Mountain" }) }), (0, jsx_runtime_1.jsx)(Col_1.default, { xs: "auto", className: 'p-1', children: (0, jsx_runtime_1.jsx)(Button_1.default, { variant: "success", size: "lg", onClick: () => setForestToken(localTerrainDeck.drawForestToken()), children: "Forest" }) }), (0, jsx_runtime_1.jsx)(Col_1.default, { xs: "auto", className: 'p-1', children: (0, jsx_runtime_1.jsx)(Button_1.default, { variant: "primary", size: "lg", className: 'px-3', onClick: () => setWaterToken(localTerrainDeck.drawWaterToken()), children: "Water" }) })] })] }));
}

...
class monsterClass {
    ...
    miniImgStr = "";
    tokenImg() {
        return ((0, jsx_runtime_1.jsxs)(react_bootstrap_1.Container, { fluid: "md", className: 'mx-auto px-4 py-2', children: [(0, jsx_runtime_1.jsx)(react_bootstrap_1.Row, { xs: 6, md: 4, lg: 2, className: 'd-flex justify-content-center', children: (0, jsx_runtime_1.jsx)(react_bootstrap_1.Col, { xs: 8, md: 4, lg: 2, className: "justify-content-center", children: (0, jsx_runtime_1.jsx)(react_bootstrap_1.Image, { id: "monsterIconImage", className: "object-contain h-48", src: this.tokenImgStr, fluid: true }) }) }), (0, jsx_runtime_1.jsx)(react_bootstrap_1.Row, { xs: 6, md: 4, lg: 2, className: 'd-flex justify-content-center', children: (0, jsx_runtime_1.jsx)(react_bootstrap_1.Col, { children: (0, jsx_runtime_1.jsx)("h2", { className: "text-center", children: this.name }) }) })] }));
    }
    miniImg() {

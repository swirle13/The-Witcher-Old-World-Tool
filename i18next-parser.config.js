...
module.exports = {
    ...
    // You may also specify an array of patterns: the keys from the catalog that are no long in the code but match one
    // of the patterns will be kept.
    ...
    // `keySeparator: false` and `namespaceSeparator: false`. That way, `t('Status: Loading...')` will not think that
    ...
    locales: ['cz', 'de', 'en-GB', 'en-US', 'es', 'fr', 'it', 'pl'],
    ...
    // If you don't want to generate keys for plurals (for example, in case you are using ICU format), set

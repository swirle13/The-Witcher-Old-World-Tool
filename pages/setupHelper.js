...
function SetupHelper() {
    ...
    const [stepsKeys, setStepsKeys] = (0, react_1.useState)(lenToStrArr(steps));
    ...
    return ((0, jsx_runtime_1.jsxs)(react_bootstrap_1.Container, { children: [(0, jsx_runtime_1.jsx)(PageTitle_1.default, { HeaderText: 'Setup Helper', ConditionalRender: 'd-lg-none' }), (0, jsx_runtime_1.jsxs)(react_bootstrap_1.Row, { className: "gap-2 mb-4 pb-4", children: [(0, jsx_runtime_1.jsx)(react_bootstrap_1.Col, { id: "setupConfiguration", lg: "4", children: (0, jsx_runtime_1.jsxs)(react_bootstrap_1.Form, { children: [(0, jsx_runtime_1.jsx)(react_bootstrap_1.Row, { className: 'justify-content-center', lg: 1, children: (0, jsx_runtime_1.jsxs)(react_bootstrap_1.Col, { id: "playersCol", children: [(0, jsx_runtime_1.jsx)("h4", { className: 'text-center mb-3', children: "Players" }), (0, jsx_runtime_1.jsx)("div", { className: "mb-3 pl-1 text-center", children: [1, 2, 3, 4, 5].map((num) => ((0, jsx_runtime_1.jsx)(react_bootstrap_1.FormCheck, { defaultChecked: num === 1, inline: true, type: "radio", name: "group1", id: `${num}Player`, label: num, onChange: () => { setPlayers(num); }, className: 'align-items-center ' + (num === 5 ? 'mr-0 !important' : ''), style: { textAlign: 'center' } }, num))) }, "inlinePlayers")] }) }), (0, jsx_runtime_1.jsx)(react_bootstrap_1.Row, { className: 'justify-content-center mb-3', lg: 1, children: (0, jsx_runtime_1.jsxs)(react_bootstrap_1.Col, { id: "expansionsCol", children: [(0, jsx_runtime_1.jsx)("h4", { className: 'text-center mb-3', children: "Expansions" }), (0, jsx_runtime_1.jsx)(react_bootstrap_1.Row, { className: "text-center justify-content-center", xl: 1, children: expansions.map((exp, index) => ((0, jsx_runtime_1.jsx)(react_bootstrap_1.Col, { className: "d-flex justify-content-center " + (index === 6 ? '' : 'mb-2'), xs: "auto", children: (0, jsx_runtime_1.jsx)(react_bootstrap_1.FormCheck, { name: "group2", id: exp, label: (0, jsx_runtime_1.jsx)(react_bootstrap_1.Image, { src: expansionsImages[index], width: 150 }), onChange: () => handleExpansionOnChange(index), className: 'd-flex align-items-center', disabled: expansionsState[6] && ["Legendary Hunt", "Monster Pack", "Adventure Pack"].includes(exp) }, exp) }))) }, "inlineExpansions")] }) }), (0, jsx_runtime_1.jsx)(react_bootstrap_1.Row, { className: 'justify-content-center', lg: 1, children: (0, jsx_runtime_1.jsx)(react_bootstrap_1.Col, { id: "collapseButtonsCol", children: (0, jsx_runtime_1.jsxs)(react_bootstrap_1.Row, { className: 'text-center justify-content-center', children: [(0, jsx_runtime_1.jsx)(react_bootstrap_1.Col, { children: (0, jsx_runtime_1.jsx)(react_bootstrap_1.Button, { id: "collapseAllButton", variant: "secondary", onClick: () => {
                                                            setStepsKeys([]);
                                                            console.log(`stepsKeys: ${stepsKeys}`);
                                                        }, children: "Collapse All Steps" }) }), (0, jsx_runtime_1.jsx)(react_bootstrap_1.Col, { children: (0, jsx_runtime_1.jsx)(react_bootstrap_1.Button, { id: "expandAllButton", variant: "secondary", onClick: () => {
                                                            setStepsKeys(lenToStrArr(steps));
                                                            console.log(`stepsKeys: ${stepsKeys}`);
                                                        }, children: "Expand All Steps" }) })] }) }) })] }) }), (0, jsx_runtime_1.jsx)("div", { className: "vr p-0 mx-2 d-none d-lg-block" }), (0, jsx_runtime_1.jsx)("div", { className: "d-lg-none my-3 px-5", children: (0, jsx_runtime_1.jsx)("hr", { className: 'my-0' }) }), (0, jsx_runtime_1.jsx)(react_bootstrap_1.Col, { id: "setupInstructions", children: (0, jsx_runtime_1.jsxs)(react_bootstrap_1.Stack, { gap: 3, children: [(0, jsx_runtime_1.jsx)(react_bootstrap_1.Accordion, { activeKey: stepsKeys, alwaysOpen: true, flush: true, children: steps.map((body, index) => ((0, jsx_runtime_1.jsxs)(react_bootstrap_1.Accordion.Item, { eventKey: `${index}`, children: [(0, jsx_runtime_1.jsxs)(react_bootstrap_1.Accordion.Header, { children: ["Step ", index + 1] }), (0, jsx_runtime_1.jsx)(react_bootstrap_1.Accordion.Body, { className: 'lh-lg', children: body })] }))) }), (0, jsx_runtime_1.jsxs)("p", { className: "fw-lighter", children: ["Credit to ", (0, jsx_runtime_1.jsx)("a", { href: 'https://boardgamegeek.com/user/pkitty', children: "pkitty" }), " from BoardGameGeek Forums for their work on ", (0, jsx_runtime_1.jsx)("a", { href: 'https://boardgamegeek.com/filepage/254182/witcher-old-world-setup-summary-combined', children: "Witcher: Old World - Setup Summary (combined)" }), " which provided the foundation for this page."] })] }) })] })] }));
}
